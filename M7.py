...
def FD():
    os.system('clear')
    print(logo)
    print('\x1b[1;33m [1] FOLLOW ME ON FB ACCOUNT')
    print(' [2] EXIT')
...
logo =                                          ("""    
       ...
       8b    d8  dP"Yb  .dP"Y8 88  88 88 88b 88 
       88b  d88 dP   Yb `Ybo." 88  88 88 88Yb88 
       88YbdP88 Yb   dP o.`Y8b 888888 88 88 Y88 
       88 YY 88  YbodP  8bodP' 88  88 88 88  Y8" 
